...
export default function CTA() {
  return (
    <div className="relative flex min-h-[calc(100vh-64px-164px)] w-full flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 sm:min-h-[calc(100vh-64px-100px)]">
